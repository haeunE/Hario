...
## :pushpin: 주요기능
- 홈페이지 : CJ사업별 COVID에 따른 변화, 최신 기사 
- COVID분석 : 시기 별 COVID 감염수 분석
- CJ 대한통운 분석 : 대한통운 분석 COVID에 따른 물류 변화
- 게시판 : 직장인(부서별), 구직자 게시판  
- 로그인 : 직장인일 경우 고유번호 지정되어있어 이를 불러와 로그인 간편하게 수행
- 극복페이지 : 산업별 COVID 극복 방안
